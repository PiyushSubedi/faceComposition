...
public class MedianFilter{
    ...
    public BufferedImage filter(BufferedImage srcImage) {
        BufferedImage dstImage = new BufferedImage(256, 256, BufferedImage.TYPE_INT_RGB);
...
//set the new pixel value using the median just found
    ...
    {
        BufferedImage src = ImageIO.read(new File("C:\\Users\\subedipiyush\\Desktop\\xyz.jpg"));
        
        new MedianFilter(5).filter(src); 
        //ImageIO.write(dest,"jpg",new File("C:\\Users\\subedipiyush\\Desktop\\xy.jpg"));
    }
